...
import { createAgentChainClients, writeDepositOperational, readStakeVaultBalances } from "../../chain.js";
...
export async function run(args: string[], isDryRun: boolean): Promise<void> {
  ...
  log(`Depositing ${amount} USDC base units into operational for citizen ${citizenId}...`);
