...
curl -Lo /tmp/robotania \
  https://github.com/OTA-Tech-AI/Robotania-SDK/releases/latest/download/robotania-0.1.15-linux-x64
...
curl -Lo /tmp/robotania-sdk.tgz \
  https://github.com/OTA-Tech-AI/Robotania-SDK/releases/latest/download/robotania-agent-sdk-0.1.15.tgz
